...
fn settings_input_rejects_a_missing_field() {
    ...
    // en felt-default paa skrive-siden, saa "komplet" betyder de TI
    // paakraevede — `stt_keywords` kom til 2026-08-05 og er paakraevet som de
    // oevrige ni, netop fordi det IKKE har en felt-default. De tre json'er
    // ovenfor mangler stadig praecis ét paakraevet felt hver. Testen bestaar
    // altsaa fortsat af den rigtige grund.
...
fn settings_input_accepterer_alt_felterne_udeladt() {
    ...
    //
    // `stt_keywords` staar MED i begge literaler, selv om testen ikke handler
    // om det: feltet er paakraevet (ingen felt-default), saa uden det ville
    // testen fejle paa noget helt andet end alt-felterne og dermed maale det
    // forkerte.
    let uden_alt = r#"{"ptt_hotkey":"Mouse4","exit_type_mode_hotkey":"Shift+Escape","voice_engine":"pipeline","wallpaper":"blue-folds","default_agent":"claude","stt_provider":"openai","routing_provider":"vercel","dictation_hotkey":"CmdOrCtrl+Shift+KeyD","dictation_submit":false,"stt_keywords":[]}"#;
    let parsed =
    ...
    let med_null = r#"{"ptt_hotkey":"Mouse4","ptt_hotkey_alt":null,"exit_type_mode_hotkey":"Shift+Escape","voice_engine":"pipeline","wallpaper":"blue-folds","default_agent":"claude","stt_provider":"openai","routing_provider":"vercel","dictation_hotkey":"CmdOrCtrl+Shift+KeyD","dictation_hotkey_alt":null,"dictation_submit":false,"stt_keywords":[]}"#;
    let parsed =
